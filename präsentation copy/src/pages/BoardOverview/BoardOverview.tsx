 ...
 * @arch-subtitle Container-View: Boards-Liste + Neu-anlegen-Dialog
 * @arch-summary Liest Boards aus dem localStorage via `getBoards`, verwaltet sie mit `useBoardOverviewReducer` und rendert pro Board eine `BoardCard`.
 * @arch-step 1
 */
