 ...
 * @arch-subtitle Container-View: drei Spalten + Board-Titel-Edit
 * @arch-summary Holt das Board ueber `useParams` + `getBoardById`, haelt seinen State mit `useBoardDetailReducer` und verteilt die Tasks per `column`-Filter auf drei `BoardColumn`-Spalten.
 * @arch-step 1
 */
