 ...
 * @arch-subtitle Modal-Dialog auf Basis von Radix Dialog
 * @arch-summary Komposit-Wrapper um `radix-ui` Dialog mit eigenem Overlay, Content, Header, Footer und Close-Button.
 */
function Dialog({
  ...props
